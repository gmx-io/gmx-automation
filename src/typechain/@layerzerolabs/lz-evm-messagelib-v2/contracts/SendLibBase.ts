...
] & { eid: number; config: ExecutorConfigStructOutput };
...
export type DefaultExecutorConfigsSetEventFilter =
  TypedEventFilter<DefaultExecutorConfigsSetEvent>;
...
export type ExecutorConfigSetEventFilter =
  TypedEventFilter<ExecutorConfigSetEvent>;
...
export type TreasuryNativeFeeCapSetEvent = TypedEvent<
  [BigNumber],
  TreasuryNativeFeeCapSetEventObject
>;

export type TreasuryNativeFeeCapSetEventFilter =
  TypedEventFilter<TreasuryNativeFeeCapSetEvent>;
...
export interface SendLibBase extends BaseContract {
  ...
  functions: {
    ...
    getExecutorConfig(
      ...
      [ExecutorConfigStructOutput] & { rtnConfig: ExecutorConfigStructOutput }
    >;
  ...
  filters: {
    "DefaultExecutorConfigsSet(tuple[])"(
      params?: null
    ): DefaultExecutorConfigsSetEventFilter;
    DefaultExecutorConfigsSet(
      params?: null
    ): DefaultExecutorConfigsSetEventFilter;

    "ExecutorConfigSet(address,uint32,tuple)"(
      oapp?: null,
      eid?: null,
      config?: null
    ): ExecutorConfigSetEventFilter;
    ExecutorConfigSet(
      oapp?: null,
      eid?: null,
      config?: null
    ...
    "TreasuryNativeFeeCapSet(uint256)"(
      newTreasuryNativeFeeCap?: null
    ): TreasuryNativeFeeCapSetEventFilter;
