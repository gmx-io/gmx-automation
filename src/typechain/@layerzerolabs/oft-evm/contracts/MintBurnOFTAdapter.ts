...
export interface MintBurnOFTAdapterInterface extends utils.Interface {
  functions: {
...
export interface MintBurnOFTAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintBurnOFTAdapterInterface;
