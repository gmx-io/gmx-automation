...
} from "../../../contracts/interfaces/IOverridableInboundRatelimit";
...
export class IOverridableInboundRatelimit__factory {
  ...
  static createInterface(): IOverridableInboundRatelimitInterface {
    return new Interface(_abi) as IOverridableInboundRatelimitInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IOverridableInboundRatelimit;
  }
}
