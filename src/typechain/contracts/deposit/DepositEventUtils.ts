...
export interface DepositEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool),bytes32[]),uint8)": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "createEventData"): FunctionFragment;

  encodeFunctionData(
    functionFragment: "createEventData",
    values: [Deposit.PropsStruct, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface DepositEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DepositEventUtilsInterface;
  ...
  functions: {
    createEventData(
      ...
      depositType: PromiseOrValue<BigNumberish>,
