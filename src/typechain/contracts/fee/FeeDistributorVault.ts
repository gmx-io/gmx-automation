...
export interface FeeDistributorVaultInterface extends utils.Interface {
  functions: {
...
export interface FeeDistributorVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeDistributorVaultInterface;
