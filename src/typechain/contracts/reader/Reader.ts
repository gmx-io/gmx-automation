...
export declare namespace ReaderUtils {
  ...
  export type OrderInfoStructOutput = [string, Order.PropsStructOutput] & {
    orderKey: string;
...
export interface ReaderInterface extends utils.Interface {
  functions: {
    ...
    "getAccountPositionInfoList(address,address,address,address[],((uint256,uint256),(uint256,uint256),(uint256,uint256))[],address,uint256,uint256)": FunctionFragment;
    ...
    "getPendingPositionImpactPoolDistributionAmount(address,address)": FunctionFragment;
    ...
    "getPositionInfoList(address,address,bytes32[],((uint256,uint256),(uint256,uint256),(uint256,uint256))[],address)": FunctionFragment;
    ...
    "isPositionLiquidatable(address,address,bytes32,(address,address,address,address),((uint256,uint256),(uint256,uint256),(uint256,uint256)),bool,bool)": FunctionFragment;
  };
...
export interface Reader extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[ReaderUtils.OrderInfoStructOutput[]]>;
