...
export interface ReaderDepositUtilsInterface extends utils.Interface {
  functions: {
    ...
    "getDepositAmountOutForSingleToken((DataStore,(address,address,address,address),((uint256,uint256),(uint256,uint256),(uint256,uint256)),address,(uint256,uint256),address,(uint256,uint256),uint256,int256,address,uint8),bool)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [
      ReaderDepositUtils.GetDepositAmountOutForSingleTokenParamsStruct,
      PromiseOrValue<boolean>
    ]
  ): string;
