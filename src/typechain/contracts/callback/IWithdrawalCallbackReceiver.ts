...
export interface IWithdrawalCallbackReceiver extends BaseContract {
  ...
  functions: {
    afterWithdrawalCancellation(
      ...
      withdrawal: EventUtils.EventLogDataStruct,
