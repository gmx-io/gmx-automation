...
export interface WithdrawalVaultInterface extends utils.Interface {
  functions: {
...
export interface WithdrawalVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WithdrawalVaultInterface;
