...
export interface WithdrawalEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool),bytes32[]),uint8)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [Withdrawal.PropsStruct, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface WithdrawalEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WithdrawalEventUtilsInterface;
  ...
  functions: {
    createEventData(
      ...
      withdrawalType: PromiseOrValue<BigNumberish>,
