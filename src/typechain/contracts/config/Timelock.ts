...
export interface TimelockInterface extends utils.Interface {
  functions: {
    ...
    "setDataStreamAfterSignal(address,bytes32,uint256,uint256)": FunctionFragment;
    ...
    "setOracleProviderForTokenAfterSignal(address,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "setOracleProviderForTokenAfterSignal"
  ...
  encodeFunctionData(
    functionFragment: "setOracleProviderForTokenAfterSignal",
