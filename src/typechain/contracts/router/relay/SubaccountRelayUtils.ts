...
export interface SubaccountRelayUtilsInterface extends utils.Interface {
  functions: {
    ...
    "getCancelOrderStructHash(((address[],address[],bytes[]),(address[],bytes[],address[],address[]),(address,address,uint256,uint256,uint8,bytes32,bytes32,address)[],(address,uint256,address[]),uint256,uint256,bytes,uint256),(address,bool,uint256,uint256,bytes32,uint256,uint256,bytes),address,bytes32)": FunctionFragment;
    "getCreateOrderStructHash(((address[],address[],bytes[]),(address[],bytes[],address[],address[]),(address,address,uint256,uint256,uint8,bytes32,bytes32,address)[],(address,uint256,address[]),uint256,uint256,bytes,uint256),(address,bool,uint256,uint256,bytes32,uint256,uint256,bytes),address,uint256,((address,address,address,address,address,address,address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),uint8,uint8,bool,bool,bool,bytes32,bytes32[]))": FunctionFragment;
    ...
    "getSubaccountApprovalStructHash((address,bool,uint256,uint256,bytes32,uint256,uint256,bytes))": FunctionFragment;
    "getUpdateOrderStructHash(((address[],address[],bytes[]),(address[],bytes[],address[],address[]),(address,address,uint256,uint256,uint8,bytes32,bytes32,address)[],(address,uint256,address[]),uint256,uint256,bytes,uint256),(address,bool,uint256,uint256,bytes32,uint256,uint256,bytes),address,bytes32,(uint256,uint256,uint256,uint256,uint256,bool),bool)": FunctionFragment;
  };
