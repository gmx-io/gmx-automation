...
export interface ExchangeRouterInterface extends utils.Interface {
  functions: {
    ...
    "simulateExecuteLatestDeposit((address[],(uint256,uint256)[],uint256,uint256))": FunctionFragment;
    "simulateExecuteLatestOrder((address[],(uint256,uint256)[],uint256,uint256))": FunctionFragment;
    "simulateExecuteLatestShift((address[],(uint256,uint256)[],uint256,uint256))": FunctionFragment;
    "simulateExecuteLatestWithdrawal((address[],(uint256,uint256)[],uint256,uint256),uint8)": FunctionFragment;
