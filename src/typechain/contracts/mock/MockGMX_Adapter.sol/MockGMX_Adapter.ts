...
export interface MockGMX_AdapterInterface extends utils.Interface {
  functions: {
...
export type RateLimitsChangedEventFilter =
  TypedEventFilter<RateLimitsChangedEvent>;

export interface MockGMX_Adapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockGMX_AdapterInterface;
  ...
  functions: {
    ...
    minterBurner(overrides?: CallOverrides): Promise<[string]>;

    modifyOverridableGUIDs(
      _guids: PromiseOrValue<BytesLike>[],
      _canOverride: PromiseOrValue<boolean>,
  ...
  filters: {
    ...
    "RateLimitsChanged(tuple[])"(
      rateLimitConfigs?: null
    ): RateLimitsChangedEventFilter;
  ...
  estimateGas: {
    ...
    minterBurner(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    minterBurner(overrides?: CallOverrides): Promise<PopulatedTransaction>;
