...
export interface MockGelatoRelayRouterInterface extends utils.Interface {
  functions: {
    ...
    "testCancelOrderSignature(((address[],address[],bytes[]),(address[],uint256[],address[],bytes[],address[],address[]),(address,address,uint256,uint256,uint8,bytes32,bytes32,address)[],(address,uint256,address[]),uint256,uint256,bytes,uint256),bytes32,address,uint256)": FunctionFragment;
