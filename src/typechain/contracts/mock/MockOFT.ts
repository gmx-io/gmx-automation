...
export interface MockOFTInterface extends utils.Interface {
  functions: {
    ...
    "buildMsgAndOptions((uint32,bytes32,uint256,uint256,bytes,bytes,bytes),uint256)": FunctionFragment;
    "combineOptions(uint32,uint16,bytes)": FunctionFragment;
    "credit(address,uint256,uint32)": FunctionFragment;
    "debit(uint256,uint256,uint32)": FunctionFragment;
    "debitView(uint256,uint256,uint32)": FunctionFragment;
    ...
    "toLD(uint64)": FunctionFragment;
    "toSD(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "buildMsgAndOptions",
    values: [SendParamStruct, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "debitView", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "decimalConversionRate",
    data: BytesLike
  ): Result;
...
export interface MockOFT extends BaseContract {
  ...
  functions: {
    ...
    buildMsgAndOptions(
      ...
      _amountToCreditLD: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ...
    debit(
      _amountToSendLD: PromiseOrValue<BigNumberish>,
      _minAmountToCreditLD: PromiseOrValue<BigNumberish>,
    ...
    debitView(
      ...
      [BigNumber, BigNumber] & {
        amountDebitedLD: BigNumber;
        amountToCreditLD: BigNumber;
      }
    >;
