...
export interface EndpointV2MockInterface extends utils.Interface {
  functions: {
    ...
    "readResponseLookup(address)": FunctionFragment;
    ...
    "setReadResponse(address,bytes)": FunctionFragment;
...
export interface EndpointV2Mock extends BaseContract {
  ...
  functions: {
    ...
    setReadResponse(
      destAddr: PromiseOrValue<string>,
      resolvedPayload: PromiseOrValue<BytesLike>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
