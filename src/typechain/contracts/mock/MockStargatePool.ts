...
export interface MockStargatePoolInterface extends utils.Interface {
  functions: {
...
export interface MockStargatePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockStargatePoolInterface;
