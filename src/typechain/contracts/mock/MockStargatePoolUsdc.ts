...
export interface MockStargatePoolUsdcInterface extends utils.Interface {
  functions: {
...
export interface MockStargatePoolUsdc extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockStargatePoolUsdcInterface;
