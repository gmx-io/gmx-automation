...
export interface MockStargatePoolNativeInterface extends utils.Interface {
  functions: {
...
export interface MockStargatePoolNative extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockStargatePoolNativeInterface;
