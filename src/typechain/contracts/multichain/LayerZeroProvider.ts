...
export interface LayerZeroProviderInterface extends utils.Interface {
  functions: {
    ...
    "multichainOrderRouter()": FunctionFragment;
...
export interface LayerZeroProvider extends BaseContract {
  ...
  functions: {
    ...
    multichainOrderRouter(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    multichainOrderRouter(overrides?: CallOverrides): Promise<BigNumber>;
