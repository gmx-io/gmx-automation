...
export interface MultichainReceiverInterface extends utils.Interface {
  functions: {
...
export interface MultichainReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultichainReceiverInterface;
