...
export interface MultichainSenderInterface extends utils.Interface {
  functions: {
    "endpoint()": FunctionFragment;
    "oAppVersion()": FunctionFragment;
    "owner()": FunctionFragment;
    "peers(uint32)": FunctionFragment;
    "quote(uint32,bytes,bytes)": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "sendMessage(uint32,bytes,bytes)": FunctionFragment;
...
export interface MultichainSender extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultichainSenderInterface;
