...
export interface ShiftEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address),(uint256,uint256,uint256,uint256,uint256,uint256),bytes32[]))": FunctionFragment;
  };
...
export interface ShiftEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShiftEventUtilsInterface;
