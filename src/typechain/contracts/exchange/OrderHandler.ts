...
export interface OrderHandlerInterface extends utils.Interface {
  functions: {
    "_executeOrder(bytes32,((address,address,address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool,bool),bytes32[]),address,bool)": FunctionFragment;
    "cancelOrder(bytes32)": FunctionFragment;
    "createOrder(address,uint256,((address,address,address,address,address,address,address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),uint8,uint8,bool,bool,bool,bytes32,bytes32[]),bool)": FunctionFragment;
    "dataStore()": FunctionFragment;
    "decreaseOrderExecutor()": FunctionFragment;
    "eventEmitter()": FunctionFragment;
    "executeOrder(bytes32,(address[],address[],bytes[]))": FunctionFragment;
    "increaseOrderExecutor()": FunctionFragment;
    ...
    "swapOrderExecutor()": FunctionFragment;
    "updateOrder(bytes32,uint256,uint256,uint256,uint256,uint256,bool,((address,address,address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool,bool),bytes32[]),bool)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "decreaseOrderExecutor",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "increaseOrderExecutor",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "swapOrderExecutor",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OrderHandler extends BaseContract {
  ...
  functions: {
    _executeOrder(
      ...
      isSimulation: PromiseOrValue<boolean>,
    ...
    decreaseOrderExecutor(overrides?: CallOverrides): Promise<[string]>;
    ...
    increaseOrderExecutor(overrides?: CallOverrides): Promise<[string]>;
    ...
    swapOrderExecutor(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    decreaseOrderExecutor(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    increaseOrderExecutor(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    swapOrderExecutor(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    swapOrderExecutor(overrides?: CallOverrides): Promise<PopulatedTransaction>;
