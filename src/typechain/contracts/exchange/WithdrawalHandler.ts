...
export interface WithdrawalHandlerInterface extends utils.Interface {
  functions: {
    "_executeWithdrawal(bytes32,((address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256),(bool)),address,uint8)": FunctionFragment;
