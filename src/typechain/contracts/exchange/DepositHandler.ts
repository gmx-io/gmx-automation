...
export interface DepositHandlerInterface extends utils.Interface {
  functions: {
    "_executeDeposit(bytes32,((address,address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256),(bool)),address)": FunctionFragment;
