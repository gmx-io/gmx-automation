...
export interface PositionStoreUtilsInterface extends utils.Interface {
  functions: {
    ...
    "PENDING_IMPACT_AMOUNT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "PENDING_IMPACT_AMOUNT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PositionStoreUtils extends BaseContract {
  ...
  functions: {
    ...
    PENDING_IMPACT_AMOUNT(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    PENDING_IMPACT_AMOUNT(overrides?: CallOverrides): Promise<BigNumber>;
