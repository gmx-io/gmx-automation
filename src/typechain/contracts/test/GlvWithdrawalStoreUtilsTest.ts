...
export interface GlvWithdrawalStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setGlvWithdrawal(address,bytes32,((address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256),(bool)))": FunctionFragment;
  };
