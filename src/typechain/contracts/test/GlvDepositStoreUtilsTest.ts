...
export interface GlvDepositStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setGlvDeposit(address,bytes32,((address,address,address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool),bytes32[]))": FunctionFragment;
  };
