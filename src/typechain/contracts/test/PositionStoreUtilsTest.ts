...
export interface PositionStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setPosition(address,bytes32,((address,address,address),(uint256,uint256,uint256,int256,uint256,uint256,uint256,uint256,uint256,uint256),(bool)))": FunctionFragment;
  };
