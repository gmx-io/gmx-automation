...
export interface WithdrawalStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setWithdrawal(address,bytes32,((address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool),bytes32[]))": FunctionFragment;
  };
