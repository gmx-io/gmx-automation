...
export interface OrderStoreUtilsTestInterface extends utils.Interface {
  functions: {
    ...
    "setOrder(address,bytes32,((address,address,address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool,bool),bytes32[]))": FunctionFragment;
  };
