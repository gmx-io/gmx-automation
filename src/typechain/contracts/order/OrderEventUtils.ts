...
export interface OrderEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address,address,address[]),(uint8,uint8,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool,bool,bool),bytes32[]))": FunctionFragment;
  };
...
export interface OrderEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OrderEventUtilsInterface;
