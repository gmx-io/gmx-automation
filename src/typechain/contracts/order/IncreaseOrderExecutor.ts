...
export interface IncreaseOrderExecutorInterface extends utils.Interface {
  functions: {
...
export interface IncreaseOrderExecutor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IncreaseOrderExecutorInterface;
