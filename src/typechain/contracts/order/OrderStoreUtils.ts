...
export interface OrderStoreUtilsInterface extends utils.Interface {
  functions: {
    ...
    "VALID_FROM_TIME()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "VALID_FROM_TIME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface OrderStoreUtils extends BaseContract {
  ...
  functions: {
    ...
    VALID_FROM_TIME(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    VALID_FROM_TIME(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    VALID_FROM_TIME(overrides?: CallOverrides): Promise<PopulatedTransaction>;
