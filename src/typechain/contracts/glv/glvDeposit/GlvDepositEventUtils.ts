...
export interface GlvDepositEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool,bool),bytes32[]))": FunctionFragment;
  };
...
export interface GlvDepositEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GlvDepositEventUtilsInterface;
