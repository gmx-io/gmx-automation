...
export interface GlvDepositStoreUtilsInterface extends utils.Interface {
  functions: {
    ...
    "IS_MARKET_TOKEN_DEPOSIT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "IS_MARKET_TOKEN_DEPOSIT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GlvDepositStoreUtils extends BaseContract {
  ...
  functions: {
    ...
    IS_MARKET_TOKEN_DEPOSIT(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    IS_MARKET_TOKEN_DEPOSIT(overrides?: CallOverrides): Promise<BigNumber>;
