...
export interface GlvWithdrawalEventUtilsInterface extends utils.Interface {
  functions: {
    "createEventData(((address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool),bytes32[]))": FunctionFragment;
  };
  ...
  encodeFunctionData(
    ...
    values: [GlvWithdrawal.PropsStruct]
  ): string;
...
export interface GlvWithdrawalEventUtils extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GlvWithdrawalEventUtilsInterface;
